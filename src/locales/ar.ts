export const ar = {
  ...
  settingsAccountRow:"تسجيل الدخول / إنشاء حساب",
  authGatewayTitle:"أهلًا بك 👋",
  authGatewaySubtitle:"سجّل دخولك عشان تحتفظ بمنشوراتك وتزامنها بين أجهزتك",
  ...
  authUsernamePh:"اسم المستخدم",
  authPasswordPh:"كلمة المرور",
  authConfirmPasswordPh:"تأكيد كلمة المرور",
  authSubmitLogin:"تسجيل الدخول",
  authSubmitSignup:"إنشاء الحساب",
  authWithGoogleShort:"أو المتابعة عبر جوجل",
  authPreviewNote:"معاينة تصميم فقط حالياً — تسجيل الدخول الفعلي غير مفعّل بعد 🔜",
  ...
  mdToolHr:"خط فاصل",
  mdPhBold:"نص عريض",mdPhItalic:"نص مائل",mdPhStrike:"نص",
  mdPhCode:"code",mdPhLinkText:"نص الرابط",mdPhImageAlt:"وصف الصورة",
